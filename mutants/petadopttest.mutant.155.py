...
class TestPet(unittest.TestCase):
    ...
    def test_invalid_adopt(self):
        ...
        self.assertEqual(result, "Buddy is already adopted.")
...
class TestAdoptionCenter(unittest.TestCase):
    ...
    def test_organize_event(self):
        result = self.center.organize_event(event_id=(1+1), title="Adoption Day", description="Adopt your new best friend!", date="2021-08-30")
